...
namespace GiftForMyLove.Models
{
    public partial class Plan
    {
        public Plan()
        {
            PairedPlans = new HashSet<PairedPlan>();
        }
        ...
        public DateTime? NgayKyHdMua { get; set; }
        public DateTime? NgayGiaoHdMua { get; set; }
        public DateTime? NgayKyHdBan { get; set; }

        public virtual ICollection<PairedPlan> PairedPlans { get; set; }
    }
}
